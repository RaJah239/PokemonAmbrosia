; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_HOLY_ARMOUR
	const EFFECT_OHKO
	const EFFECT_SUPER_FANG ; not used
	const EFFECT_STATIC_DAMAGE
	const EFFECT_TRAP_TARGET
	const EFFECT_JUDGEMENT
	const EFFECT_DOUBLE_FLINCH_HIT
	...
	const EFFECT_RETURN
	const EFFECT_PRESENT ; removed
	const EFFECT_FRUSTRATION ;removed
	...
	const EFFECT_FAKE_OUT ; can be removed
	const EFFECT_BELLY_DRUM
	const EFFECT_PSYCH_UP ; can be removed
	...
	const EFFECT_GUST
	const EFFECT_STOMP ; can be removed
