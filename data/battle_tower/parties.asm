...
; Leader level
    ...
    db SCYTHER
	db EVIOLITE
	db WING_ATTACK, QUICK_ATTACK, X_SCISSOR, ROOST
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
    ...
    db HONCHKROW
	db LIFE_ORB
	db FLY, SUCKER_PUNCH, CLOSE_COMBAT, ROOST
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
...
; ELITE level
	...
	db VENUSAUR
	db MIRACLE_SEED
	db SUNNY_DAY, SOLARBEAM, EARTH_POWER, TOXIC_SPIKES
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db WEAVILE
	db FOCUS_SASH
	db SWORDS_DANCE, AVALANCHE, NIGHT_SLASH, DRAIN_PUNCH
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
	...
	db GENGAR
	db FOCUS_SASH
	db SHADOW_BALL, SLUDGE_BOMB, TAUNT, EXPLOSION
	dw 0 ; OT ID
	dt 0 ; Exp
	; Stat exp
	bigdw 65500
