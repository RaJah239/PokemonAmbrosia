...
BattleAnim_XScissor:
	...
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $0, $8, $10
	anim_wait 4
	anim_obj BATTLE_ANIM_OBJ_CUT_LONG_DOWN_LEFT, 18, 4,  5, 0, $0
	anim_obj BATTLE_ANIM_OBJ_CUT_LONG_DOWN_RIGHT, 14, 4,  5, 0, $0
	anim_wait 20
...
BattleAnim_DarkPulse:
	...
	anim_bgp $1b
	anim_sound 0, 1, SFX_SPITE
	anim_obj BATTLE_ANIM_OBJ_WAVE, 44, 88, $0
	anim_obj BATTLE_ANIM_OBJ_WAVE, 44, 88, $8
	anim_obj BATTLE_ANIM_OBJ_WAVE, 44, 88, $10
	anim_obj BATTLE_ANIM_OBJ_WAVE, 44, 88, $18
	anim_obj BATTLE_ANIM_OBJ_WAVE, 44, 88, $20
	anim_obj BATTLE_ANIM_OBJ_WAVE, 44, 88, $28
	anim_obj BATTLE_ANIM_OBJ_WAVE, 44, 88, $30
	anim_obj BATTLE_ANIM_OBJ_WAVE, 44, 88, $38
	anim_incobj 1
	anim_incobj 2
	anim_incobj 3
	anim_incobj 4
...
BattleAnim_SuckerPunch:
	...
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $4, $2
	anim_sound 0, 1, SFX_KARATE_CHOP
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 122, 52, $0
	anim_wait 12
	anim_call BattleAnimSub_SpeedLines
	anim_wait 8
	anim_bgeffect BATTLE_BG_EFFECT_SHOW_MON, $0, $1, $0
...
.loop
	anim_sound 0, 1, SFX_EMBER
	anim_obj BATTLE_ANIM_OBJ_SAND, 116, 72, $0
	anim_wait 2
	anim_obj BATTLE_ANIM_OBJ_SAND, 132, 72, $0
	anim_wait 2
	anim_obj BATTLE_ANIM_OBJ_SAND, 148, 72, $0
	anim_wait 16
	anim_loop 3, .loop
	anim_wait 32
...
BattleAnim_FlashCannon:
	anim_2gfx BATTLE_ANIM_GFX_HAZE, BATTLE_ANIM_GFX_CHARGE
	anim_bgeffect BATTLE_BG_EFFECT_ALTERNATE_HUES, $0, $2, $0
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $60, $2, $0
...
BattleAnim_ElectricTackle:
	...
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $2
	anim_sound 0, 1, SFX_THUNDER
	anim_obj BATTLE_ANIM_OBJ_THUNDER_WAVE, 152, 68, $0
	anim_wait 64
	anim_bgeffect BATTLE_BG_EFFECT_SHOW_MON, $0, BG_EFFECT_USER, $0
	anim_ret
...
BattleAnim_MeteorMash:
	...
	anim_wait 6
	anim_sound 0, 1, SFX_MOVE_PUZZLE_PIECE
	anim_obj BATTLE_ANIM_OBJ_HIT_BIG_YFIX, 17, 0,  7, 0, $0
	anim_wait 20
	anim_call BattleAnim_ImpactfulPunchSub
...
.loop
	...
	anim_wait 1
	anim_obj BATTLE_ANIM_OBJ_HIT_BIG_YFIX, 148, 56, $0
	anim_wait 2
	anim_sound 0, 1, SFX_KARATE_CHOP
	anim_obj BATTLE_ANIM_OBJ_PUNCH, 122, 34, $0
	anim_wait 1
	anim_obj BATTLE_ANIM_OBJ_HIT_BIG_YFIX, 122, 34, $0
	anim_wait 2
	anim_sound 0, 1, SFX_KARATE_CHOP
	...
	anim_wait 1
	anim_obj BATTLE_ANIM_OBJ_HIT_BIG_YFIX, 140, 42, $0
	anim_wait 2
	anim_sound 0, 1, SFX_KARATE_CHOP
	anim_obj BATTLE_ANIM_OBJ_PUNCH, 114, 52, $0
	anim_wait 1
	anim_obj BATTLE_ANIM_OBJ_HIT_BIG_YFIX, 114, 52, $0
	anim_wait 2
	anim_loop 4, .loop
	anim_wait 16
	anim_ret
...
.loop
	...
	anim_obj BATTLE_ANIM_OBJ_ENCORE_STAR, 128, 48, $28
	anim_obj BATTLE_ANIM_OBJ_HIT_BIG_YFIX, 128, 48, $0
	anim_wait 3
	anim_obj BATTLE_ANIM_OBJ_HEART, 144, 64, $5c
	anim_wait 3
	anim_obj BATTLE_ANIM_OBJ_ENCORE_STAR, 144, 64, $10
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 144, 64, $0
	anim_wait 3
	anim_sound 0, 1, SFX_DOUBLESLAP
	anim_obj BATTLE_ANIM_OBJ_HEART, 120, 52, $e8
	anim_wait 3
	anim_obj BATTLE_ANIM_OBJ_ENCORE_STAR, 120, 52, $9c
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 120, 52, $0
	anim_wait 3
	anim_obj BATTLE_ANIM_OBJ_ENCORE_STAR, 152, 48, $d0
	anim_wait 3
	anim_sound 6, 2, SFX_SLUDGE_BOMB
	anim_obj BATTLE_ANIM_OBJ_HEART, 152, 48, $1c
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 152, 48, $0
	anim_wait 3
	anim_obj BATTLE_ANIM_OBJ_ENCORE_STAR, 136, 56, $50
	anim_wait 3
	anim_sound 0, 1, SFX_KARATE_CHOP
	anim_obj BATTLE_ANIM_OBJ_HEART, 136, 56, $dc
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 136, 56, $0
	anim_wait 3
	anim_obj BATTLE_ANIM_OBJ_ENCORE_STAR, 128, 48, $90
	anim_loop 2, .loop
	anim_bgeffect BATTLE_BG_EFFECT_SHOW_MON, $0, $1, $0
	anim_ret
