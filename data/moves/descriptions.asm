...
OblivionDescription:
	...
	line "from the victim.@"

ThouArrowsDescription:
	db   "A piercing light"
	line "that always hits.@"
...
CloseCombatDescription:
	db   "A storm of precise"
	line "and mighty blows.@"
