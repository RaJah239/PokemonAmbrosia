	...
	db  95,  70,  73,  60, 100,  90
	;   hp  atk  def  spd  sat  sdf

	db FAIRY, FAIRY ; type
	db 25 ; catch rate
	db 129 ; base exp
	db STAR_PIECE, MOON_STONE ; items
