...
.a:        db DEINO, ARBOK, HONCHKROW, GALVANTULA, FROGADIER, UNOWN, -1
.i:        db EEVEE, GEODUDE, JOLTIK, PILOSWINE, ONIX, -1
.u:        db ARCANINE, GENESECT, MIMIKYU, VICTREEBEL, MARSHTOMP, SWINUB, -1
...
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, GARDEVOIR, GALLADE, KLEAVOR, WARTORTLE, BLASTOISE, MAMOSWINE, MARILL, AZUMARILL, RHYPERIOR, -1
.ki_gi:    db METAGROSS, VENIPEDE, GYARADOS, RAPIDASH, NINETALES, BAGON, SYLVEON, KINGDRA, MILOTIC, -1
...
.sa_za:    db RHYHORN, PUPITAR, NOWN, SOLOSIS, ZAPDOS, JOLTEON, ROTOM, POLTEGEIST, -1 ; RHYDON should lead this list
...
.so_zo:    db MELTAN, -1
.ta_da:    db DRACOVISH, SNEASLER, EXEGGCUTE, -1
.chi_dhi:  db TREECKO, FRIGIBAX, -1
.tsu_du:   db SHAYMIN, -1
.te_de:    db ARCTOZOLT, LATIOS, KYOGRE, HOUNDOUR, AMPHAROS, -1
.to_do:    db ELECTIVIRE, MAGNEZONE, SMEARGLE, ZWEILOUS, TENTACRUEL, TOGETIC, TOGEPI, MAGMORTAR, WHIRLIPEDE, WHIMSICOTT, -1
...
.nu:       db SWAMPERT, -1
.ne:       db TOGEKISS, NINETALES_A, -1
.no:       db HYDREIGON, -1
.ha_ba_pa: db YANMEGA, STEELIX, INFERNAPE, DRAGONAIR, SCOLIPEDE, SCIZOR, TIMBURR, BLISSEY, ZYGARDE, HAWLUCHA, GARCHOMP, MR__MIME, DIALGA, CLOYSTER, TYRANITAR, -1
...
.ma:       db DEOXYS, LATIAS, MONFERNO, BELLSPROUT, WEEZING, MISMAGIUS, PORYGONZ, BAXCALIBUR, SHROOMISH, GROUDON, -1
