...
# File path
file_path = 'data/pokemon/big_pic_pointers_png.asm' # full list of 	dba	CyndaquilFrontpic, etc
...
def read_pal_file(pokemon_name):
    ...
    pal_path = f"gfx/pokemon/{pokemon_name}/shiny.pal"
    colors = []
...
def create_pokemon_grid(pokemon_names, grid_size=(15, 17), cell_size=56, border_width=2):
...
# Main execution
file_path = "data/pokemon/big_pic_pointers_png.asm"
