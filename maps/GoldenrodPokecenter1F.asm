...
GoldenrodPokecenter1FPokefanF:
    jumptextfaceplayer GoldenrodPokecenter1FPokefanFDaughterWillBeDelightedText
...
GoldenrodPokecenter1FGameboyKidText:
	...
	line "was going to be a"
	cont "huge building here"
	cont "which would use"
	cont "your mobile phone"
	cont "IRL to trade and"
	cont "battle."

	para "It was really"
	line "ambitious for"
	cont "a game developed"
	cont "in the late 90s!"
	done

GoldenrodPokecenter1FLassText:
	text "I moved here to"
	line "follow my dream"
	cont "of becoming a"
	cont "famous actress."
