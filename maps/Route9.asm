...
Route9_MapEvents:
	...
	object_event 17,  7, SPRITE_RAICHU, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Route9FieldMon4Script, EVENT_FIELD_MON_4
