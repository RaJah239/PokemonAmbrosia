...
SilverCaveRoom2_MapEvents:
	...
	object_event 14, 41, SPRITE_MACHAMP, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom2FieldMon1Script, EVENT_FIELD_MON_1
	object_event 19, 44, SPRITE_GALLADE, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom2FieldMon2Script, EVENT_FIELD_MON_2
	object_event 14, 48, SPRITE_HERACROSS, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom2FieldMon3Script, EVENT_FIELD_MON_3
	object_event  7, 39, SPRITE_CONKELDURR, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom2FieldMon4Script, EVENT_FIELD_MON_4
	object_event 17, 52, SPRITE_URSALUNA, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom2FieldMon5Script, EVENT_FIELD_MON_5
	object_event 20, 52, SPRITE_URSALUNA_B, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom2FieldMon6Script, EVENT_FIELD_MON_6
	...
	object_event  5, 32, SPRITE_BAXCALIBUR, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom2FieldMon8Script, EVENT_FIELD_MON_8
