...
UnionCaveB2F_MapEvents:
	...
	object_event 11, 31, SPRITE_DRAGON, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, UnionCaveLapras, EVENT_UNION_CAVE_B2F_LAPRAS
	
	object_event 15, 29, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, UnionCaveB2FFieldMon1Script, EVENT_FIELD_MON_1
   	object_event  9, 32, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_DEEP_RED, OBJECTTYPE_TRAINER, 2, UnionCaveB2FFieldMon2Script, EVENT_FIELD_MON_2
   	...
   	object_event  2, 26, SPRITE_MONSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_SCRIPT, 0, UnionCaveB2FFieldMon4Script, EVENT_FIELD_MON_4
